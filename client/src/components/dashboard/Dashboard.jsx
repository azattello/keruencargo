...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (role === 'filial' && (selectedNavItem === 'CourseManager' || selectedNavItem === 'sendings')) {
      setSelectedNavItem('addTrack');
      sessionStorage.setItem('selectedNavItem', 'addTrack');
    }
  }, [role, selectedNavItem]);
  ...
  return (
    <>
      ...
      <div className="dashboard">
        ...
        {role !== 'filial' && selectedNavItem === "CourseManager" && <CourseManager />}
        {role !== 'filial' && selectedNavItem === "sendings" && <Sendings />}
